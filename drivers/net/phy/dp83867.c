...
#define DP83867_REG_LED_2_OFFSET	8
#define DP83867_REG_LED_1_OFFSET	4
...
static int dp83867_config_init(struct phy_device *phydev)
{
	...
	/* Set LED2 as blink for transmit or receive activity mode */
	val &= ~(0xf << DP83867_REG_LED_2_OFFSET);
	val |= (0xb << DP83867_REG_LED_2_OFFSET);

	/* Set LED1 as 1000BT link established mode */
	val &= ~(0xf << DP83867_REG_LED_1_OFFSET);
	val |= (0x5 << DP83867_REG_LED_1_OFFSET);
